...
class BoxesConnector:
    def __init__(self, max_dist=None, overlap_threshold=None):
        # x轴方向上合并框阈值
    ...
    def __call__(self, rects: np.ndarray, image_width: int):
        """_summary_
